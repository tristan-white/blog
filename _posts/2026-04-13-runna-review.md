...
It asks if you're preparing for a certain race. I searched for and selected the [Canberra Marathon](https://solemotive.com/pages/canberra-times-marathon-marathon). It then imports info about the race, such as date and elevation profile.
...
1. **Beginner**: You can complete a 3 mile run without stopping, in under 60 minutes.
2. **Intermediate**: You regularly run at least 3 mile but don't structure your training or put thought into a plan.
3. **Advanced**: You regularly run at least 6 miles and do some structured training e.g. intervals.
4. **Elite**: You regularly run half-marathons or further and are experienced with structured training e.g. intervals.
